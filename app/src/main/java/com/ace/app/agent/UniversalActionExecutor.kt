 ...
 * Responsible ONLY for action execution and reporting execution facts. Does NOT evaluate goal verification.
 */
            ...
            primitive.contains("open_app") || primitive == "app.launch" || primitive == "open" -> {
                ...
                if (intent != null) {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("target_package" to appInfo.packageName, "action_type" to "open_app")
                    )
                } else {
                    UniversalActionResult(
                        status = ActionResultStatus.FAILED,
            ...
            primitive.contains("open_url") || primitive == "web.open" || primitive == "url" -> {
                ...
                try {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("target_url" to url, "action_type" to "open_url")
                    )
                } catch (e: Exception) {
                    UniversalActionResult(
                        status = ActionResultStatus.FAILED,
            ...
            primitive.contains("search") -> {
                ...
                try {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("query" to query, "action_type" to "search")
                    )
                } catch (e: Exception) {
            ...
            primitive.contains("play") || primitive.contains("media") -> {
                ...
                if (directResult != null && directResult.isVerified) {
                    UniversalActionResult(
                        ...
                        outputData = mapOf("query" to query, "action_type" to "play_media")
                    )
                } else {
            ...
            primitive.contains("click") -> {
                ...
                if (service == null || !AceAccessibilityService.isServiceEnabled(context)) {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("action_type" to "click", "target" to target)
                    )
                }
            }
            ...
            primitive.contains("type") || primitive.contains("enter") || primitive.contains("fill") -> {
                ...
                if (service == null || !AceAccessibilityService.isServiceEnabled(context)) {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("action_type" to "type", "inputText" to inputText)
                    )
                }
            }
            ...
            primitive.contains("scroll") -> {
                ...
                if (service == null || !AceAccessibilityService.isServiceEnabled(context)) {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("action_type" to "scroll")
                    )
                }
            }
            ...
            primitive.contains("back") || primitive.contains("navigate_back") -> {
                ...
                if (service != null && AceAccessibilityService.isServiceEnabled(context)) {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("action_type" to "back")
                    )
                } else {
                    UniversalActionResult(
                        status = ActionResultStatus.FAILED,
                ...
                try {
                    ...
                    if (cameraManager != null && cameraId != null) {
                        ...
                        UniversalActionResult(
                            ...
                            outputData = mapOf("hardware_action" to "flashlight", "torch_state" to "$turnOn")
                        )
                    } else {
                        UniversalActionResult(
                            status = ActionResultStatus.FAILED,
                ...
                try {
                    ...
                    if (audioManager != null) {
                        ...
                        UniversalActionResult(
                            ...
                            outputData = mapOf("hardware_action" to "volume", "direction" to "$direction")
                        )
                    } else {
                        UniversalActionResult(
                            status = ActionResultStatus.FAILED,
            ...
            primitive.contains("setting") -> {
                try {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("action_type" to "settings")
                    )
                } catch (e: Exception) {
                    UniversalActionResult(
                        status = ActionResultStatus.FAILED,
            ...
            primitive.contains("share") || primitive.contains("send") -> {
                ...
                try {
                    ...
                    UniversalActionResult(
                        ...
                        outputData = mapOf("share_payload" to textPayload, "action_type" to "share")
                    )
                } catch (e: Exception) {
                    UniversalActionResult(
                        status = ActionResultStatus.FAILED,
